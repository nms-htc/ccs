				...
				<div>
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<div class="form-group">
							...
							<?php bbp_form_topic_type_dropdown( array( 'class' => 'form-control') ); ?>
						...
						</divbbp_get_form_topic_status_dropdown>
					...
					<div class="form-group">
						...
						<button type="submit" class="btn btn-primary" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
