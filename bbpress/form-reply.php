		...
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<?php if ( !bbp_is_topic_open() && !bbp_is_reply_edit() ) : ?>
					...
					<p class="alert alert-info"><?php _e( 'This topic is marked as closed to new replies, however your posting capabilities still allow you to do so.', 'bbpress' ); ?></p>
				...
				<div>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_reply_edit() ) : ?>
						...
						<fieldset class="bbp-form">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" value="<?php bbp_form_reply_edit_reason(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_reply_edit_reason" id="bbp_reply_edit_reason" />
							</div>
						</fieldset>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" class="btn btn-primary" tabindex="<?php bbp_tab_index(); ?>" id="bbp_reply_submit" name="bbp_reply_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
...
<?php elseif ( bbp_is_topic_closed() ) : ?>
	...
	<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
		<p class="alert alert-warning"><?php printf( __( 'The topic &#8216;%s&#8217; is closed to new replies.', 'bbpress' ), bbp_get_topic_title() ); ?></p>
	</div>

<?php elseif ( bbp_is_forum_closed( bbp_get_topic_forum_id() ) ) : ?>

	<div id="no-reply-<?php bbp_topic_id(); ?>" class="bbp-no-reply">
		<p class="alert alert-warning"><?php printf( __( 'The forum &#8216;%s&#8217; is closed to new topics and replies.', 'bbpress' ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></p>
	</div>
